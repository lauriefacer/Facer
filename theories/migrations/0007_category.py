...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('theories', '0006_auto_20200718_1402'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tn_parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tn_children', to='theories.Category', verbose_name='Parent')),
            ],
            options={
