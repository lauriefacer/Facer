...
/* stylelint-disable */
/* stylelint-enable */
.zippy-react-toolkit-split-button.zippy-react-toolkit-split-button--theme-light {
  color: #495e85;
  fill: #495e85;
  font-size: 14px;
  min-height: 32px;
  ...
  /* stylelint-disable */
  /* stylelint-enable */ }
  .zippy-react-toolkit-split-button.zippy-react-toolkit-split-button--theme-light:not(.zippy-react-toolkit-split-button--disabled) .zippy-react-toolkit-split-button__icon-wrap:hover {
    background: #edeff3; }
  .zippy-react-toolkit-split-button.zippy-react-toolkit-split-button--theme-light.zippy-react-toolkit-split-button--focused {
    border: 1px dotted #3c5c99; }
  .zippy-react-toolkit-split-button.zippy-react-toolkit-split-button--theme-light .zippy-react-toolkit-split-button__button {
    padding: 4px 8px;
    color: #495e85;
    font-size: 14px;
    background: #e4e7ed; }
    .zippy-react-toolkit-split-button.zippy-react-toolkit-split-button--theme-light .zippy-react-toolkit-split-button__button:not(.zippy-react-toolkit-button--disabled):hover {
      background: #edeff3; }
    .zippy-react-toolkit-split-button.zippy-react-toolkit-split-button--theme-light .zippy-react-toolkit-split-button__button:not(.zippy-react-toolkit-button--disabled):active {
      background: #edeff3; }
  .zippy-react-toolkit-split-button.zippy-react-toolkit-split-button--theme-light:not(.zippy-react-toolkit-split-button--disabled) .zippy-react-toolkit-dropdown-button__button:hover {
    background: #edeff3; }
  .zippy-react-toolkit-split-button.zippy-react-toolkit-split-button--theme-light .zippy-react-toolkit-dropdown-button__button {
    overflow: hidden;
    background: #e4e7ed;
    fill: #495e85; }
  .zippy-react-toolkit-split-button.zippy-react-toolkit-split-button--theme-light.zippy-react-toolkit-split-button--expanded .zippy-react-toolkit-dropdown-button__button {
    background: #edeff3; }
  .zippy-react-toolkit-split-button.zippy-react-toolkit-split-button--theme-light .zippy-react-toolkit-split-button__button.zippy-react-toolkit-button--ltr.zippy-react-toolkit-button--icon-first .zippy-react-toolkit-button__icon-wrap {
    margin-right: 6px; }
  .zippy-react-toolkit-split-button.zippy-react-toolkit-split-button--theme-light .zippy-react-toolkit-split-button__button.zippy-react-toolkit-button--ltr.zippy-react-toolkit-button--icon-last .zippy-react-toolkit-button__icon-wrap {
    margin-left: 6px; }
  .zippy-react-toolkit-split-button.zippy-react-toolkit-split-button--theme-light .zippy-react-toolkit-dropdown-button__button:not(.zippy-react-toolkit-button--disabled) .zippy-react-toolkit-button__icon-wrap:hover:not(.zippy-react-toolkit-button__icon-wrap--disabled) {
    background: #edeff3; }
  .zippy-react-toolkit-split-button.zippy-react-toolkit-split-button--theme-light:not(.zippy-react-toolkit-split-button--disabled) .zippy-react-toolkit-dropdown-button__button.zippy-react-toolkit-button--ltr.zippy-react-toolkit-button--icon-last .zippy-react-toolkit-button__icon-wrap {
    border-left: 1px solid #fff; }
  .zippy-react-toolkit-split-button.zippy-react-toolkit-split-button--theme-light:not(.zippy-react-toolkit-split-button--disabled) .zippy-react-toolkit-dropdown-button--expanded .zippy-react-toolkit-dropdown-button__button.zippy-react-toolkit-button--ltr.zippy-react-toolkit-button--icon-last .zippy-react-toolkit-button__icon-wrap, .zippy-react-toolkit-split-button.zippy-react-toolkit-split-button--theme-light:not(.zippy-react-toolkit-split-button--disabled):hover .zippy-react-toolkit-dropdown-button__button.zippy-react-toolkit-button--ltr.zippy-react-toolkit-button--icon-last .zippy-react-toolkit-button__icon-wrap, .zippy-react-toolkit-split-button.zippy-react-toolkit-split-button--theme-light:not(.zippy-react-toolkit-split-button--disabled):active .zippy-react-toolkit-dropdown-button__button.zippy-react-toolkit-button--ltr.zippy-react-toolkit-button--icon-last .zippy-react-toolkit-button__icon-wrap {
    border-left: 1px solid #fff; }
  .zippy-react-toolkit-split-button.zippy-react-toolkit-split-button--theme-light .zippy-react-toolkit-dropdown-button__button.zippy-react-toolkit-button--ltr.zippy-react-toolkit-button--icon-first .zippy-react-toolkit-button__icon-wrap {
    border-right: 1px solid #fff; }
    .zippy-react-toolkit-split-button.zippy-react-toolkit-split-button--theme-light .zippy-react-toolkit-dropdown-button__button.zippy-react-toolkit-button--ltr.zippy-react-toolkit-button--icon-first .zippy-react-toolkit-button__icon-wrap:hover:not(.zippy-react-toolkit-button__icon-wrap--disabled) {
      border-right: 1px solid #fff; }
  .zippy-react-toolkit-split-button.zippy-react-toolkit-split-button--theme-light:not(.zippy-react-toolkit-split-button--disabled) .zippy-react-toolkit-dropdown-button--expanded .zippy-react-toolkit-dropdown-button__button.zippy-react-toolkit-button--ltr.zippy-react-toolkit-button--icon-first .zippy-react-toolkit-button__icon-wrap, .zippy-react-toolkit-split-button.zippy-react-toolkit-split-button--theme-light:not(.zippy-react-toolkit-split-button--disabled):hover .zippy-react-toolkit-dropdown-button__button.zippy-react-toolkit-button--ltr.zippy-react-toolkit-button--icon-first .zippy-react-toolkit-button__icon-wrap, .zippy-react-toolkit-split-button.zippy-react-toolkit-split-button--theme-light:not(.zippy-react-toolkit-split-button--disabled):active .zippy-react-toolkit-dropdown-button__button.zippy-react-toolkit-button--ltr.zippy-react-toolkit-button--icon-first .zippy-react-toolkit-button__icon-wrap {
    border-right: 1px solid #fff; }
  .zippy-react-toolkit-split-button.zippy-react-toolkit-split-button--theme-light .zippy-react-toolkit-dropdown-button__button.zippy-react-toolkit-button--rtl.zippy-react-toolkit-button--icon-last .zippy-react-toolkit-button__icon-wrap {
    border-right: 1px solid #fff; }
    .zippy-react-toolkit-split-button.zippy-react-toolkit-split-button--theme-light .zippy-react-toolkit-dropdown-button__button.zippy-react-toolkit-button--rtl.zippy-react-toolkit-button--icon-last .zippy-react-toolkit-button__icon-wrap:hover:not(.zippy-react-toolkit-button__icon-wrap--disabled) {
      border-right: 1px solid #fff; }
  .zippy-react-toolkit-split-button.zippy-react-toolkit-split-button--theme-light:not(.zippy-react-toolkit-split-button--disabled) .zippy-react-toolkit-dropdown-button--expanded .zippy-react-toolkit-dropdown-button__button.zippy-react-toolkit-button--rtl.zippy-react-toolkit-button--icon-last .zippy-react-toolkit-button__icon-wrap, .zippy-react-toolkit-split-button.zippy-react-toolkit-split-button--theme-light:not(.zippy-react-toolkit-split-button--disabled):hover .zippy-react-toolkit-dropdown-button__button.zippy-react-toolkit-button--rtl.zippy-react-toolkit-button--icon-last .zippy-react-toolkit-button__icon-wrap, .zippy-react-toolkit-split-button.zippy-react-toolkit-split-button--theme-light:not(.zippy-react-toolkit-split-button--disabled):active .zippy-react-toolkit-dropdown-button__button.zippy-react-toolkit-button--rtl.zippy-react-toolkit-button--icon-last .zippy-react-toolkit-button__icon-wrap {
    border-right: 1px solid #fff; }
  .zippy-react-toolkit-split-button.zippy-react-toolkit-split-button--theme-light .zippy-react-toolkit-dropdown-button__button.zippy-react-toolkit-button--rtl.zippy-react-toolkit-button--icon-first .zippy-react-toolkit-button__icon-wrap {
    border-left: 1px solid #fff; }
    .zippy-react-toolkit-split-button.zippy-react-toolkit-split-button--theme-light .zippy-react-toolkit-dropdown-button__button.zippy-react-toolkit-button--rtl.zippy-react-toolkit-button--icon-first .zippy-react-toolkit-button__icon-wrap:hover:not(.zippy-react-toolkit-button__icon-wrap--disabled) {
      border-left: 1px solid #fff; }
  .zippy-react-toolkit-split-button.zippy-react-toolkit-split-button--theme-light:not(.zippy-react-toolkit-split-button--disabled) .zippy-react-toolkit-dropdown-button--expanded .zippy-react-toolkit-dropdown-button__button.zippy-react-toolkit-button--rtl.zippy-react-toolkit-button--icon-first .zippy-react-toolkit-button__icon-wrap, .zippy-react-toolkit-split-button.zippy-react-toolkit-split-button--theme-light:not(.zippy-react-toolkit-split-button--disabled):hover .zippy-react-toolkit-dropdown-button__button.zippy-react-toolkit-button--rtl.zippy-react-toolkit-button--icon-first .zippy-react-toolkit-button__icon-wrap, .zippy-react-toolkit-split-button.zippy-react-toolkit-split-button--theme-light:not(.zippy-react-toolkit-split-button--disabled):active .zippy-react-toolkit-dropdown-button__button.zippy-react-toolkit-button--rtl.zippy-react-toolkit-button--icon-first .zippy-react-toolkit-button__icon-wrap {
    border-left: 1px solid #fff; }
  .zippy-react-toolkit-split-button.zippy-react-toolkit-split-button--theme-light .zippy-react-toolkit-split-button__button.zippy-react-toolkit-button--rtl.zippy-react-toolkit-button--icon-first .zippy-react-toolkit-button__icon-wrap {
    margin-left: 6px; }
  .zippy-react-toolkit-split-button.zippy-react-toolkit-split-button--theme-light .zippy-react-toolkit-split-button__button.zippy-react-toolkit-button--rtl.zippy-react-toolkit-button--icon-last .zippy-react-toolkit-button__icon-wrap {
    margin-right: 6px; }
  .zippy-react-toolkit-split-button.zippy-react-toolkit-split-button--theme-light .zippy-react-toolkit-dropdown-button__arrow {
    padding-left: 2px;
    padding-right: 2px; }
  .zippy-react-toolkit-split-button.zippy-react-toolkit-split-button--theme-light .zippy-react-dropdown-button__button.zippy-react-toolkit-button--ltr.zippy-react-toolkit-button--icon-first .zippy-react-toolkit-button__text {
    padding-left: 0; }
  .zippy-react-toolkit-split-button.zippy-react-toolkit-split-button--theme-light .zippy-react-dropdown-button__button.zippy-react-toolkit-button--ltr.zippy-react-toolkit-button--icon-first .zippy-react-toolkit-dropdown-button__arrow {
    margin-right: 6px;
    padding-left: 8px; }
  .zippy-react-toolkit-split-button.zippy-react-toolkit-split-button--theme-light .zippy-react-dropdown-button__button.zippy-react-toolkit-button--ltr.zippy-react-toolkit-button--icon-last .zippy-react-toolkit-button__text {
    padding-right: 0; }
  .zippy-react-toolkit-split-button.zippy-react-toolkit-split-button--theme-light .zippy-react-dropdown-button__button.zippy-react-toolkit-button--ltr.zippy-react-toolkit-button--icon-last .zippy-react-toolkit-dropdown-button__arrow {
    margin-left: 6px;
    padding-right: 8px; }
  .zippy-react-toolkit-split-button.zippy-react-toolkit-split-button--theme-light .zippy-react-dropdown-button__button.zippy-react-toolkit-button--rtl.zippy-react-toolkit-button--icon-first .zippy-react-toolkit-button__text {
    padding-right: 0; }
  .zippy-react-toolkit-split-button.zippy-react-toolkit-split-button--theme-light .zippy-react-dropdown-button__button.zippy-react-toolkit-button--rtl.zippy-react-toolkit-button--icon-first .zippy-react-toolkit-dropdown-button__arrow {
    margin-left: 6px;
    padding-right: 8px; }
  .zippy-react-toolkit-split-button.zippy-react-toolkit-split-button--theme-light .zippy-react-dropdown-button__button.zippy-react-toolkit-button--rtl.zippy-react-toolkit-button--icon-last .zippy-react-toolkit-button__text {
    padding-left: 0; }
  .zippy-react-toolkit-split-button.zippy-react-toolkit-split-button--theme-light .zippy-react-dropdown-button__button.zippy-react-toolkit-button--rtl.zippy-react-toolkit-button--icon-last .zippy-react-toolkit-dropdown-button__arrow {
    margin-right: 6px;
    padding-left: 8px; }
