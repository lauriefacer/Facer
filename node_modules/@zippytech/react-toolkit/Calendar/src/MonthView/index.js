...
var MonthView = function (_Component) {
  ...
  _createClass(MonthView, [{
    ...
    value: function renderNavBar(props) {
      ...
      var defaultProps = (0, _assignDefined2.default)({}, {
      ...
      if (!childNavBar) {
        if (props.navigation || props.renderNavBar) {
          return this.renderNavBarComponent((0, _assignDefined2.default)(_extends({}, defaultProps, {
      ...
      var navBarProps = (0, _assign2.default)({}, childNavBar.props, (0, _assignDefined2.default)(_extends({}, defaultProps, {
        viewMoment: props.viewMoment,
        date: props.moment,
        theme: theme,
        ref: ref,
    ...
    value: function onChange(_ref6, event) {
      ...
      if (this.props.onChange) {
        ...
        this.props.onChange(dateString, { dateMoment: dateMoment, timestamp: timestamp, dateString: dateString, noCollapse: noCollapse }, event);
      }
    }
  }, {
...
MonthView.propTypes = {
  ...
  onHoverRangeChange: _propTypes2.default.func,
