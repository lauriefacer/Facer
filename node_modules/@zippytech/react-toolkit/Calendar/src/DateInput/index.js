  ...
  _createClass(DateInput, [{
    ...
    value: function renderPicker() {
      ...
      if (this.isExpanded()) {
        ...
        var viewDate =
        // newExpand && date && (typeof date === 'object' ? date.isValid() : true)
        //   ? date
        // :
        ...
        var pickerElement = _react2.default.cloneElement(picker, (0, _assignDefined2.default)({
          ...
          onViewDateChange: (0, _joinFunctions2.default)(pickerProps.onViewDateChange, this.onViewDateChange),
          onActiveDateChange: (0, _joinFunctions2.default)(pickerProps.onActiveDateChange, this.onActiveDateChange),
        ...
        if (this.props.renderPicker) {
          renderResult = this.props.renderPicker(result);
...
DateInput.propTypes = {
  ...
  defaultViewDate: _propTypes2.default.any,
  renderPicker: _propTypes2.default.func,
