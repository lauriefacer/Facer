 ...
 * LICENSE file in the root directory of this source tree.
 */
.zippy-react-toolkit-button-group.zippy-react-toolkit-button-group--theme-light
...
:not(.zippy-react-toolkit-button-group.zippy-react-toolkit-button-group--rtl) .zippy-react-toolkit-button-group__button:first-child {
  ...
  .zippy-react-toolkit-button-group.zippy-react-toolkit-button-group--theme-light
:not(.zippy-react-toolkit-button-group.zippy-react-toolkit-button-group--rtl) .zippy-react-toolkit-button-group__button.zippy-react-toolkit-button--pressed, .zippy-react-toolkit-button-group.zippy-react-toolkit-button-group--theme-light
:not(.zippy-react-toolkit-button-group.zippy-react-toolkit-button-group--rtl) .zippy-react-toolkit-button-group__button.zippy-react-toolkit-split-button--pressed, .zippy-react-toolkit-button-group.zippy-react-toolkit-button-group--theme-light
:not(.zippy-react-toolkit-button-group.zippy-react-toolkit-button-group--rtl) .zippy-react-toolkit-button-group__button.zippy-react-toolkit-dropdown-button--pressed {
  ...
  .zippy-react-toolkit-button-group.zippy-react-toolkit-button-group--theme-light
:not(.zippy-react-toolkit-button-group.zippy-react-toolkit-button-group--rtl) .zippy-react-toolkit-button-group__button.zippy-react-toolkit-button, .zippy-react-toolkit-button-group.zippy-react-toolkit-button-group--theme-light
:not(.zippy-react-toolkit-button-group.zippy-react-toolkit-button-group--rtl) .zippy-react-toolkit-button-group__button.zippy-react-toolkit-split-button, .zippy-react-toolkit-button-group.zippy-react-toolkit-button-group--theme-light
:not(.zippy-react-toolkit-button-group.zippy-react-toolkit-button-group--rtl) .zippy-react-toolkit-button-group__button.zippy-react-toolkit-dropdown-button {
    ...
    .zippy-react-toolkit-button-group.zippy-react-toolkit-button-group--theme-light
:not(.zippy-react-toolkit-button-group.zippy-react-toolkit-button-group--rtl) .zippy-react-toolkit-button-group__button.zippy-react-toolkit-button.zippy-react-toolkit-button--pressed:not(:first-child), .zippy-react-toolkit-button-group.zippy-react-toolkit-button-group--theme-light
:not(.zippy-react-toolkit-button-group.zippy-react-toolkit-button-group--rtl) .zippy-react-toolkit-button-group__button.zippy-react-toolkit-button.zippy-react-toolkit-split-button--pressed:not(:first-child), .zippy-react-toolkit-button-group.zippy-react-toolkit-button-group--theme-light
:not(.zippy-react-toolkit-button-group.zippy-react-toolkit-button-group--rtl) .zippy-react-toolkit-button-group__button.zippy-react-toolkit-button.zippy-react-toolkit-dropdown-button--pressed:not(:first-child), .zippy-react-toolkit-button-group.zippy-react-toolkit-button-group--theme-light
:not(.zippy-react-toolkit-button-group.zippy-react-toolkit-button-group--rtl) .zippy-react-toolkit-button-group__button.zippy-react-toolkit-button:hover:not(:first-child), .zippy-react-toolkit-button-group.zippy-react-toolkit-button-group--theme-light
:not(.zippy-react-toolkit-button-group.zippy-react-toolkit-button-group--rtl) .zippy-react-toolkit-button-group__button.zippy-react-toolkit-split-button.zippy-react-toolkit-button--pressed:not(:first-child), .zippy-react-toolkit-button-group.zippy-react-toolkit-button-group--theme-light
:not(.zippy-react-toolkit-button-group.zippy-react-toolkit-button-group--rtl) .zippy-react-toolkit-button-group__button.zippy-react-toolkit-split-button.zippy-react-toolkit-split-button--pressed:not(:first-child), .zippy-react-toolkit-button-group.zippy-react-toolkit-button-group--theme-light
:not(.zippy-react-toolkit-button-group.zippy-react-toolkit-button-group--rtl) .zippy-react-toolkit-button-group__button.zippy-react-toolkit-split-button.zippy-react-toolkit-dropdown-button--pressed:not(:first-child), .zippy-react-toolkit-button-group.zippy-react-toolkit-button-group--theme-light
:not(.zippy-react-toolkit-button-group.zippy-react-toolkit-button-group--rtl) .zippy-react-toolkit-button-group__button.zippy-react-toolkit-split-button:hover:not(:first-child), .zippy-react-toolkit-button-group.zippy-react-toolkit-button-group--theme-light
:not(.zippy-react-toolkit-button-group.zippy-react-toolkit-button-group--rtl) .zippy-react-toolkit-button-group__button.zippy-react-toolkit-dropdown-button.zippy-react-toolkit-button--pressed:not(:first-child), .zippy-react-toolkit-button-group.zippy-react-toolkit-button-group--theme-light
:not(.zippy-react-toolkit-button-group.zippy-react-toolkit-button-group--rtl) .zippy-react-toolkit-button-group__button.zippy-react-toolkit-dropdown-button.zippy-react-toolkit-split-button--pressed:not(:first-child), .zippy-react-toolkit-button-group.zippy-react-toolkit-button-group--theme-light
:not(.zippy-react-toolkit-button-group.zippy-react-toolkit-button-group--rtl) .zippy-react-toolkit-button-group__button.zippy-react-toolkit-dropdown-button.zippy-react-toolkit-dropdown-button--pressed:not(:first-child), .zippy-react-toolkit-button-group.zippy-react-toolkit-button-group--theme-light
...
:not(.zippy-react-toolkit-button-group.zippy-react-toolkit-button-group--rtl) .zippy-react-toolkit-button-group__button.zippy-react-toolkit-button:hover + .zippy-react-toolkit-button-group__button:not(:first-child), .zippy-react-toolkit-button-group.zippy-react-toolkit-button-group--theme-light
...
:not(.zippy-react-toolkit-button-group.zippy-react-toolkit-button-group--rtl) .zippy-react-toolkit-button-group__button.zippy-react-toolkit-split-button:hover + .zippy-react-toolkit-button-group__button:not(:first-child), .zippy-react-toolkit-button-group.zippy-react-toolkit-button-group--theme-light
