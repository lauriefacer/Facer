...
.zippy-react-toolkit-dropdown-button.zippy-react-toolkit-dropdown-button--theme-light {
  color: #495e85;
  fill: #495e85;
  font-size: 14px; }
  .zippy-react-toolkit-dropdown-button.zippy-react-toolkit-dropdown-button--theme-light .zippy-react-toolkit-button__text {
    padding: 4px 8px; }
  .zippy-react-toolkit-dropdown-button.zippy-react-toolkit-dropdown-button--theme-light:not(.zippy-react-toolkit-split-button__dropdown-button) {
    background: #e4e7ed padding-box;
    min-height: 32px;
    padding: 2px 0;
    border: 1px solid transparent; }
    .zippy-react-toolkit-dropdown-button.zippy-react-toolkit-dropdown-button--theme-light:not(.zippy-react-toolkit-split-button__dropdown-button):not(.zippy-react-toolkit-dropdown-button--disabled).zippy-react-toolkit-dropdown-button--expanded, .zippy-react-toolkit-dropdown-button.zippy-react-toolkit-dropdown-button--theme-light:not(.zippy-react-toolkit-split-button__dropdown-button):not(.zippy-react-toolkit-dropdown-button--disabled):active, .zippy-react-toolkit-dropdown-button.zippy-react-toolkit-dropdown-button--theme-light:not(.zippy-react-toolkit-split-button__dropdown-button):not(.zippy-react-toolkit-dropdown-button--disabled):hover {
      background: #edeff3 padding-box; }
    .zippy-react-toolkit-dropdown-button.zippy-react-toolkit-dropdown-button--theme-light:not(.zippy-react-toolkit-split-button__dropdown-button).zippy-react-toolkit-dropdown-button--focused {
      border: 1px dotted #3c5c99; }
    .zippy-react-toolkit-dropdown-button.zippy-react-toolkit-dropdown-button--theme-light:not(.zippy-react-toolkit-split-button__dropdown-button) .zippy-react-toolkit-dropdown-button__button.zippy-react-toolkit-button--ltr.zippy-react-toolkit-button--icon-first .zippy-react-toolkit-button__text {
      padding-left: 0; }
    .zippy-react-toolkit-dropdown-button.zippy-react-toolkit-dropdown-button--theme-light:not(.zippy-react-toolkit-split-button__dropdown-button) .zippy-react-toolkit-dropdown-button__button.zippy-react-toolkit-button--ltr.zippy-react-toolkit-button--icon-first .zippy-react-toolkit-dropdown-button__arrow {
      margin-right: 6px;
      padding-left: 8px; }
    .zippy-react-toolkit-dropdown-button.zippy-react-toolkit-dropdown-button--theme-light:not(.zippy-react-toolkit-split-button__dropdown-button) .zippy-react-toolkit-dropdown-button__button.zippy-react-toolkit-button--ltr.zippy-react-toolkit-button--icon-last .zippy-react-toolkit-button__text {
      padding-right: 0; }
    .zippy-react-toolkit-dropdown-button.zippy-react-toolkit-dropdown-button--theme-light:not(.zippy-react-toolkit-split-button__dropdown-button) .zippy-react-toolkit-dropdown-button__button.zippy-react-toolkit-button--ltr.zippy-react-toolkit-button--icon-last .zippy-react-toolkit-dropdown-button__arrow {
      margin-left: 6px;
      padding-right: 2px; }
    .zippy-react-toolkit-dropdown-button.zippy-react-toolkit-dropdown-button--theme-light:not(.zippy-react-toolkit-split-button__dropdown-button) .zippy-react-toolkit-dropdown-button__button.zippy-react-toolkit-button--rtl.zippy-react-toolkit-button--icon-first .zippy-react-toolkit-button__text {
      padding-right: 0; }
    .zippy-react-toolkit-dropdown-button.zippy-react-toolkit-dropdown-button--theme-light:not(.zippy-react-toolkit-split-button__dropdown-button) .zippy-react-toolkit-dropdown-button__button.zippy-react-toolkit-button--rtl.zippy-react-toolkit-button--icon-first .zippy-react-toolkit-dropdown-button__arrow {
      margin-left: 6px;
      padding-right: 2px; }
    .zippy-react-toolkit-dropdown-button.zippy-react-toolkit-dropdown-button--theme-light:not(.zippy-react-toolkit-split-button__dropdown-button) .zippy-react-toolkit-dropdown-button__button.zippy-react-toolkit-button--rtl.zippy-react-toolkit-button--icon-last .zippy-react-toolkit-button__text {
      padding-left: 0; }
    .zippy-react-toolkit-dropdown-button.zippy-react-toolkit-dropdown-button--theme-light:not(.zippy-react-toolkit-split-button__dropdown-button) .zippy-react-toolkit-dropdown-button__button.zippy-react-toolkit-button--rtl.zippy-react-toolkit-button--icon-last .zippy-react-toolkit-dropdown-button__arrow {
      margin-right: 6px;
      padding-left: 8px; }
