...
.zippy-react-toolkit-tab-panel__tab-strip {
  ...
  flex: none;
  overflow: hidden; }
  .zippy-react-toolkit-tab-panel__tab-strip .zippy-react-toolkit-arrow-scroller--direction-horizontal {
    min-width: 100%; }
  .zippy-react-toolkit-tab-panel__tab-strip .zippy-react-toolkit-arrow-scroller--direction-vertical {
    min-height: 100%; }
  .zippy-react-toolkit-tab-panel__tab-strip:focus {
    outline: none; }
  .zippy-react-toolkit-tab-panel__tab-strip--tab-position-left .zippy-react-toolkit-arrow-scroller__inner-wrapper, .zippy-react-toolkit-tab-panel__tab-strip--tab-position-right .zippy-react-toolkit-arrow-scroller__inner-wrapper {
    min-height: 100%; }
...
.zippy-react-toolkit-tab-panel__tab-strip .zippy-react-toolkit-arrow-scroller__arrow {
  display: flex;
  align-items: center;
  justify-content: center; }
  .zippy-react-toolkit-tab-panel__tab-strip .zippy-react-toolkit-arrow-scroller__arrow--auto {
    position: absolute;
    z-index: 100; }
  .zippy-react-toolkit-tab-panel__tab-strip .zippy-react-toolkit-arrow-scroller__arrow--direction-left {
    left: 0;
    z-index: 200; }
  .zippy-react-toolkit-tab-panel__tab-strip .zippy-react-toolkit-arrow-scroller__arrow--direction-right {
    right: 0; }
  .zippy-react-toolkit-tab-panel__tab-strip .zippy-react-toolkit-arrow-scroller__arrow--direction-up {
    top: 0;
    z-index: 200; }
  .zippy-react-toolkit-tab-panel__tab-strip .zippy-react-toolkit-arrow-scroller__arrow--direction-down {
    bottom: 0; }
  .zippy-react-toolkit-tab-panel__tab-strip .zippy-react-toolkit-arrow-scroller__arrow--direction-left, .zippy-react-toolkit-tab-panel__tab-strip .zippy-react-toolkit-arrow-scroller__arrow--direction-right {
    top: 0;
    bottom: 0; }
  .zippy-react-toolkit-tab-panel__tab-strip .zippy-react-toolkit-arrow-scroller__arrow--direction-up, .zippy-react-toolkit-tab-panel__tab-strip .zippy-react-toolkit-arrow-scroller__arrow--direction-down {
    left: 0;
    right: 0; }
  .zippy-react-toolkit-tab-panel__tab-strip .zippy-react-toolkit-arrow-scroller__arrow--disabled {
    opacity: 0.5; }
  .zippy-react-toolkit-tab-panel__tab-strip .zippy-react-toolkit-arrow-scroller__arrow--hidden {
    display: none; }
...
.zippy-react-toolkit-tab-panel__tab-strip--theme-default {
  ...
  padding: 2px; }
  .zippy-react-toolkit-tab-panel__tab-strip--theme-default .zippy-react-toolkit-arrow-scroller__arrow {
    background: #d2dff0;
    border: 1px solid #a1b6d3;
    color: #495e85;
    fill: #495e85; }
    .zippy-react-toolkit-tab-panel__tab-strip--theme-default .zippy-react-toolkit-arrow-scroller__arrow--active {
      background: #e8f2ff; }
  .zippy-react-toolkit-tab-panel__tab-strip--theme-default.zippy-react-toolkit-tab-panel__tab-strip--tab-position-top .zippy-react-toolkit-arrow-scroller__arrow {
    border-bottom: 0; }
  .zippy-react-toolkit-tab-panel__tab-strip--theme-default.zippy-react-toolkit-tab-panel__tab-strip--tab-position-bottom .zippy-react-toolkit-arrow-scroller__arrow {
    border-top: 0; }
  .zippy-react-toolkit-tab-panel__tab-strip--theme-default.zippy-react-toolkit-tab-panel__tab-strip--tab-position-left .zippy-react-toolkit-arrow-scroller__arrow {
    border-right: 0; }
  .zippy-react-toolkit-tab-panel__tab-strip--theme-default.zippy-react-toolkit-tab-panel__tab-strip--tab-position-right .zippy-react-toolkit-arrow-scroller__arrow {
    border-left: 0; }
